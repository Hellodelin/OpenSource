...
public final class FacesServlet implements Servlet {
    ...
    public static final String CONFIG_FILES_ATTR =
        "javax.faces.CONFIG_FILES";//会自动载入
    ...
    private static final Logger LOGGER =
          Logger.getLogger("javax.faces.webapp", "javax.faces.LogStrings");//每一个好的框架都会有良好的日志处理系统
...
/META-INF
    ...
    /**
     * DO NOT REMOVE. Necessary for V3 probe monitoring. //应该是个监控检测工具
     */
